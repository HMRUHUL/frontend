...
const Create_Document = () => {
  ...
  const onSubmitUpdate = async (data) => {
    ...
    const updateResult = await axios
      .put(`http://localhost:4123/documents/update/${data.id}`, data)
      .then((response) => {
    ...
    swal({
      ...
      if (result) {
        const abc = await axios
          .delete(`http://localhost:4123/documents/delete/${id}`)
          .then((response) => {
            if (response.data.success) {
              getDataapicall();
            }
  ...
  const SearchData = (e) => {
    ...
    if (search == "") {
      ...
      axios
        .get(`http://localhost:4123/documents/search/${searchby_lowercase}`)
        .then((response) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <>
          <Link className="btn btn-success" to={`/viewDocuments/${record.ID}/${record.DOCUMENT_ID}`}><span class="fa fa-eye"></span></Link>
        </>
      )
    },
    {
      ...
      render: (text, record) => (
        <div className="">
          ...
          <div className="">
            ...
            >
              <i className="fa fa-pencil" style={{ fontSize: "24px", color: "white" }} />
            ...
            >
              <i className="fa fa-trash-o" style={{ fontSize: "24px", color: "white" }} />
            </a>
          </div>
                        ...
                        <div class="col-md-12">
                          <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="mb-2 row">
                              ...
                              >
                                {" "}
                                <span style={{ color: "red" }}>*</span>Document Id
                              </label>
                            ...
                            <div className="mb-2 row">
                              ...
                              >
                                {" "}
                                <span style={{ color: "red" }}>*</span>Documents Type
                              </label>
                              <div className="col-sm-8">
