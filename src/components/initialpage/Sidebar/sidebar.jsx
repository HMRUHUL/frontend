      ...
      <div className="sidebar" id="sidebar">
        <div className="sidebar-inner slimscroll">
          <div id="sidebar-menu" className="sidebar-menu">
            <ul>
              <li>
                <Link className={pathname.includes('/docs') ? "active" : ""} to="/docs"><i className="la la-home" /> <span> Dashboard</span></Link>
              </li>
              {/* add Vendor */}
              <li className="submenu text-start">
                <a href="/docs"><i className="la la-gift" /> <span> New Docs</span> <span className="menu-arrow" /></a>
                <ul style={{ display: 'none' }}>
                  ...
                  <Link className={pathname.includes('/docs/update') ? "active" : ""} to="/docs/update">
                    Update Docs
                  </Link>
              ...
              {/* add product */}
              <li className="submenu text-start">
                <a href="#"><i className="fa fa-cart-plus " /> <span> Documents List</span> <span className="menu-arrow" /></a>
                <ul style={{ display: 'none' }}>

                  <li>
                    <Link className={pathname.includes('/docs/cat') ? "active" : ""} to="/docs/cat">
                      View Categories
                    </Link>
                  </li>
                  <li>
